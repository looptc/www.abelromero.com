#!/usr/bin/perl
#
# $id: deprocpidnetcp.pl
#
# This software is copied from some gist and I don't remember if I modified it, and it's cool to share :)
#
# usage: cat /proc/net/tcp | perl $id
#
# usage: cat /proc/$pid/net/tcp | perl $id
